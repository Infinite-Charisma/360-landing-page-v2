...
const RightRoadMapList = ({ label, lists }: Props) => {
  return (
    <>
      <div className="hidden xl:block">
        <div className="flex justify-center roadmap-button-shadow">
          <button className="w-[382px] text-[32px] relative text-white gradient h-[61px] px-[16px] py-[8px] rounded-[4px] bg-[#121212] border-white border border-gradient">
            ...
            <Fade direction="right" triggerOnce={true}>
              <div className="absolute right-0 translate-x-[100%] top-[30px] translate-y-[-50%] flex items-center text-[18px]">
                <div className="w-[120px] h-[9px] bg-white horizontal-link-stick 2xl:w-[120px]"></div>
                <div className="p-[24px] rounded-[4px] border w-[280px] border-gradient feature-list-shadow">
...
export default RightRoadMapList;
